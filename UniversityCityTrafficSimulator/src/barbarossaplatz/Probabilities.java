...
import entities.Dissection;
import entities.Lane;

public class Probabilities {

    private static double[] Predictants = new double[] {6,2,20,5,4,6,1,1,1,1,1};
    ...
    public static int getNewDirection(int springID, int seed) {
            switch(springID){
                    ...
                    //A7
                    case 56:
                    case 57: return(seed<90? 3 : 2);
                    case 58: 
                    //A8
                    case 59: return(seed<90?1 : 6);
                    //A9
                    case 60: return(seed<90?2 : 1);
                    //A10
                    case 61:
                    case 62:
                    case 63: return(seed==3?3 : seed<2?3 : seed<84?1 : 2);// 
                    //A11
